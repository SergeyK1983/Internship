...
urlpatterns = [
    ...
    path('v1/pereval/<int:pk>', PerevalDetailAPI.as_view(), name='pereval-info'),
    re_path(r'^v1/update/(?P<pk>[0-9]+)/$', PerevalUpdateModeratorAPI.as_view(), name='update-mod'),
    re_path(r'^v1/pereval/update/(?P<pk>[0-9]+)/$', PerevalRetrieveUpdateAPI.as_view(), name='update-user'),
